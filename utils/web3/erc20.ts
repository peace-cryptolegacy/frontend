...
const heritageContractAddress: string = process.env.NEXT_PUBLIC_HERITAGE_CONTRACT_ADDRESS;
const mockTokenAddress: string = process.env.NEXT_PUBLIC_MOCK_TOKEN_ADDRESS;

type Approve = () => void;

// TODO: Chequear por qué esto no funciona.
